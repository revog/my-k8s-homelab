...
for any contributor. [good first issue]([TODO](https://github.com/revog/my-k8s-homelab/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)) has extra information to
help you make your first contribution. [help wanted]([TODO](https://github.com/revog/my-k8s-homelab/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22)) are issues
