...
|✅| <img width="32" src="https://gateway-api.sigs.k8s.io/images/logo/logo-text-large-horizontal-white.svg">                              | [Gateway API](https://gateway-api.sigs.k8s.io/docs/introduction/)                 | Kubernetes Gateway API implementation used for L4 and L7 routing                                                |
