...
| [Raspberry Pi 5](https://www.raspberrypi.com/products/raspberry-pi-5/) | Control Plane Node | 1 | 4 cores | 16GB | - | arm64 | [Talos Linux](https://www.talos.dev/) |
| [Beelink EQi Wildcat Lake Core 3 304](https://www.bee-link.com/de/products/beelink-eqi-wildcat-lake) | Control Plane & Worker Nodes | 2 | 10 cores | 48GB | 2 x  512GB NVMe | amd64 | [Talos Linux](https://www.talos.dev/) |
...
|✅| <img width="32" src="https://avatars.githubusercontent.com/u/314135">                                                                | [Cloudflare Tunnel](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/) | Public-facing service exposure through Cloudflare Tunnel without direct inbound connectivity |
|✅| <img width="32" src="https://avatars.githubusercontent.com/u/48932923">                                                              | [Tailscale Operator](https://tailscale.com/docs/features/kubernetes-operator) | Identity-based private networking to securely expose Kubernetes services via WireGuard-based mesh VPN |
|✅| <img width="32" src="https://gateway-api.sigs.k8s.io/images/logo/logo.svg">                                                          | [Gateway API](https://gateway-api.sigs.k8s.io)                  | Kubernetes Gateway API implementation used for L4 and L7 routing                                          |
|✅| <img width="32" src="https://github.com/cncf/artwork/raw/main/projects/flux/icon/color/flux-icon-color.svg">                         | [Flux](https://fluxcd.io/)                                      | GitOps continuous delivery for Kubernetes                                                                 |
...
|✅| <img width="32" src="https://github.com/cncf/artwork/raw/main/projects/longhorn/icon/color/longhorn-icon-color.svg">                 | [Longhorn](https://longhorn.io/)                                | Cloud-native, lightweight, reliable and easy-to-use distributed block storage system for Kubernetes    |
|✅| <img width="32" src="https://github.com/cncf/artwork/blob/main/projects/headlamp/icon/color/headlamp-icon-color.svg">                | [Headlamp](https://headlamp.dev/)                               | User-friendly Kubernetes UI with CI/CD integration                                                        |
|✅| <img width="32" src="https://github.com/stakater/Reloader/blob/master/assets/web/reloader.jpg">                                      | [Reloader](https://github.com/stakater/Reloader)                | Controller that triggers rollouts of workloads whenever referenced Secrets, ConfigMaps or optionally CSI-mounted secrets are updated. |
...
|✅| <img width="32" src="https://avatars.githubusercontent.com/u/43720803">                                                              | [VictoriaMetrics](https://victoriametrics.com)                  | Monitoring system and time series database                                                                |
|✅| <img width="32" src="https://grafana.com/static/img/menu/grafana2.svg">                                                              | [Grafana](https://grafana.com)                                  | Visualization, Analytics and monitoring dashboards                                                        |
|✅| <img width="32" src="https://avatars.githubusercontent.com/u/197418917">                                                             | [Pocket ID](https://pocket-id.org/)                             |  Identity Provider (IdP) for modern SSO with Passkey and without tradional credentials                    |
|✅| <img width="32" src="https://avatars.githubusercontent.com/u/36015203">                                                              | [Node Feature Discovery](https://kubernetes-sigs.github.io/node-feature-discovery) |  Add-on for detecting hardware features and system configuration for dynamic scheduling|
