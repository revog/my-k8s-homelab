...
|✅| <img width="32" src="https://gateway-api.sigs.k8s.io/images/logo/logo.svg">                                                          | [Gateway API](https://gateway-api.sigs.k8s.io/docs/introduction/)                 | Kubernetes Gateway API implementation used for L4 and L7 routing                                                |
...
|⚠️| <img width="32" src="https://user-images.githubusercontent.com/9879976/200943022-883194a9-1d7f-4507-a248-bf163317c8ba.svg#gh-light-mode-only">                                                              | [Zitadel](https://zitadel.com/)    |  Identity Provider (IdP) for modern SSO                                     |
