...
|⚠️| <img width="32" src="https://github.com/cncf/artwork/raw/main/projects/containerd/icon/color/containerd-icon-color.svg">             | [containerd](https://containerd.io/)                            | Industry-standard container runtime integrated with Talos Linux                                           |
...
|⚠️| <img width="32" src="https://github.com/cncf/artwork/raw/main/projects/rook/icon/color/rook-icon-color.svg">                         | [Rook-Ceph](https://rook.io/)                                   | Cloud-native storage orchestration for Kubernetes using Ceph                                              |
