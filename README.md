...
|⚠️| <img width="32" src="https://avatars.githubusercontent.com/u/314135">                                                                | [Cloudflare Tunnel](https://developers.cloudflare.com/cloudflare-one/connections/connect-networks/) | Securely exposing selected services to the internet trough Cloudflare Tunnel without exposing cluster nodes |
|⚠️| <img width="32" src="https://avatars.githubusercontent.com/u/48932923">                                                              | [Tailscale Operator](https://tailscale.com/docs/features/kubernetes-operator) | Identity-based private networking to securely expose Kubernetes services via WireGuard-based mesh VPN |
